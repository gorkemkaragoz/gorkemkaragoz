...
|---|---|---|
| [Hotel Reservation System](https://github.com/gorkemkaragoz/hotel-reservation-backend) | Spring Boot · PostgreSQL · Redis · JWT | Full-stack reservation API with Specification API, Optimistic + Pessimistic Locking, Redis cache, and role-based security |
